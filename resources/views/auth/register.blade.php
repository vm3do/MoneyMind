            ...
            <div class="max-w-md w-full space-y-8">
                ...
                <form method="POST" action="{{ route('register') }}" class="mt-8 space-y-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <!-- Date -->
                        <div>
                            <label for="date" class="block text-sm font-medium text-gray-700">Salary Day</label>
                            <div class="mt-1">
                                <input id="date" name="salary_date" type="number" required
                                    placeholder="Salary Day (1-31)"
                                    min="1" max="31"
                                    class="appearance-none block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#FF660E] focus:border-[#FF660E]"
                        ...
                        <p class="text-center text-sm text-gray-600">
                            ...
                            <a href="{{ route('login') }}" class="font-medium text-[#FF660E] hover:text-[#FF660E]/80 transition-all duration-200">
                                Sign in
                            </a>
                        </p>
                    </div>
