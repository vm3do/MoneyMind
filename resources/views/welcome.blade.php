...
<body class="bg-white">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center flex-shrink-0">
                    <a href="/" class="flex items-center">
                        <div
                            class="w-10 h-10 rounded-l-lg bg-gradient-to-br from-[#FF6B6B] to-[#fe945c] flex items-center justify-center">
                            <span class="text-xl font-bold text-white">M</span>
                        </div>
                        <div
                            class="w-10 h-10 rounded-r-lg bg-gradient-to-br from-[#000000] to-[#664938] flex items-center justify-center">
                            <span class="text-xl font-bold text-white">M</span>
                        </div>
                    </a>
                </div>
                    ...
                    <div class="flex items-center space-x-4">
                        @auth
                            @if (auth()->user()->role == 'admin')
                                <a href="{{ route('dashboard') }}"
                                    class="bg-[#FF660E] text-white px-4 py-2 rounded-lg hover:bg-[#FF660E]/90 transition-all duration-200">Dashboard</a>
                            @else
                        ...
                        @else
                            <a href="{{ route('register') }}"
                                class="bg-[#FF660E] text-white px-4 py-2 rounded-lg hover:bg-[#FF660E]/90 transition-all duration-200">Get
                                Started</a>
                            <a href="{{ route('login') }}"
                                class="inline-flex justify-center items-center px-4 py-2 border border-gray-200 text-base rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200">
                                Log in
                            </a>
                        @endauth
                    </div>
                ...
                <div class="relative md:hidden" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100"
                        ...
                        <div class="md:hidden px-2 py-4 border-b border-slate-200/60">
                            ...
                            @else
                                <a href="{{ route('register') }}"
                                    class="block text-center my-2 bg-[#FF660E] text-white px-4 py-2 rounded-lg hover:bg-[#FF660E]/90 transition-all duration-200">Get
                                    Started</a>
                                <a href="{{ route('login') }}"
                                    class="block text-center items-center px-4 py-2 border border-gray-200 text-base rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200">
                                    Log in
                                </a>
                            @endauth
    ...
    <!-- Hero Section -->
    <section class="pt-32 pb-20 bg-gradient-to-b from-[#FFF6F0] to-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative">
                    <div
                        class="absolute inset-0 bg-gradient-to-br from-[#FF660E]/30 via-[#FF8F4F]/30 to-[#FFC107]/30 opacity-30 blur-3xl rounded-full">
                    </div>
                    <img src="{{ asset('images/image.webp') }}" alt="MoneyMind "
                        class="relative rounded-2xl shadow-2xl border border-gray-100">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20" id="features">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div
                    class="bg-white p-6 rounded-xl border border-gray-100 hover:border-[#FF660E]/30 transition-all duration-200">
                    <div class="w-12 h-12 bg-[#FF660E]/10 rounded-lg flex items-center justify-center mb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#FF660E]" fill="none"
