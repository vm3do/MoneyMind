    ...
    <body class="bg-white">
        ...
        <section class="py-20" id="features">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <!-- Feature 1 -->
                    <div class="bg-white p-6 rounded-xl border border-gray-100 hover:border-[#FF660E]/30 transition-all duration-200">
                        <div class="w-12 h-12 bg-[#FF660E]/10 rounded-lg flex items-center justify-center mb-6">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#FF660E]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <p class="text-gray-600">Suivez automatiquement vos dépenses et recevez des analyses détaillées de vos habitudes financières.</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl border border-gray-100 hover:border-[#FF660E]/30 transition-all duration-200">
                        ...
                        <p class="text-gray-600">Recevez des notifications intelligentes pour rester dans les limites de votre budget.</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl border border-gray-100 hover:border-[#FF660E]/30 transition-all duration-200">
                        ...
                        <p class="text-gray-600">Automatisez l'ajout de vos revenus et la gestion de vos dépenses récurrentes.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-[#FF660E]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <a href="/register" class="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-xl text-[#FF660E] bg-white hover:bg-gray-50 transition-all duration-200">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <ul class="space-y-4">
                            <li><a href="#" class="text-base text-gray-500 hover:text-[#FF660E]">Fonctionnalités</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-4">
                            <li><a href="#" class="text-base text-gray-500 hover:text-[#FF660E]">Confidentialité</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-4">
                            <li><a href="#" class="text-base text-gray-500 hover:text-[#FF660E]">Centre d'aide</a></li>
