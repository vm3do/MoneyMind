    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center space-x-8">
                <a href="/statistics" class="text-slate-600 hover:text-[#FF6B6B] font-medium transition-colors">
                    Statistics
                </a>
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" 
                    ...
                    <div class="md:hidden px-2 py-2 border-b border-slate-200/60">
                        <a href="/statistics" class="block px-4 py-2 text-sm text-slate-600 hover:bg-slate-50 rounded-lg">Statistics</a>
                    ...
                    <!-- Profile Options -->
                    <div class="px-2 py-2">
                        <a href="/profile" class="flex items-center gap-2 px-4 py-2 text-sm text-slate-600 hover:bg-slate-50 rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            </svg>
                            Profile
                        </a>
                        <a href="/logout" class="flex items-center gap-2 px-4 py-2 text-sm text-slate-600 hover:bg-slate-50 rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
