...
<body class="bg-[#F8F9FD]" x-data="dashboard()">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <span
                                class="flex items-center gap-1 text-[#FF6B6B] text-sm mt-2 bg-gradient-to-r from-[#FF6B6B]/10 to-[#FF8E53]/10 px-2 py-0.5 rounded-full border border-[#FF6B6B]/20 w-fit">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div class="flex items-center gap-3">
                            <span
                                class="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[#FF6B6B] to-[#FF8E53] shadow-lg shadow-orange-500/30">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="relative group">
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button x-data onclick="fillForm(this)" @click="$dispatch('open-modal', 'edit-salary')"
                                class="group/edit p-2 hover:bg-[#FF6B6B]/10 rounded-lg transition-colors"
                                data-amount={{ $salary }} data-day={{ $salaryDay }}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-[#FF6B6B]">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="relative group flex-1">
                    ...
                    <div
                        class="relative bg-gradient-to-br from-white via-slate-50 to-white rounded-2xl shadow-lg p-6 border border-slate-200/60 h-full">
                        <div class="flex justify-between items-center mb-6">
                            <div class="flex items-center gap-3">
                                <span
                                    class="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[#FF6B6B] to-[#FF8E53] shadow-lg shadow-orange-500/30">
        ...
        <!-- Edit Category Modal -->
        <div x-data="{ show: false }" @open-modal.window="show = ($event.detail === 'edit-salary')"
                    ...
                    <form id="edit-form" method="POST" class="p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" min="1" max="31" name="salary_date"
                                        id="date" required
                                        class="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white text-slate-600 text-sm transition-all focus:outline-none focus:border-[#4ECDC4] focus:ring-2 focus:ring-[#4ECDC4]/20">
                                </div>
                            </div>
                            ...
                            <div class="pt-2">
                                <button type="submit"
                                    class="w-full px-4 py-3 bg-gradient-to-r from-[#4ECDC4] to-[#45B7D1] text-white rounded-xl hover:shadow-lg transition-all duration-200 font-medium">
                                    Edit Salary
                                </button>
                            </div>
                        </div>
                ...
                init() {
                    ...
                    new Chart(categoryCtx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                data: total,
                                backgroundColor: $colors = ["#FF6384", "#36A2EB", "#FFCE56", "#4BC0C0",
                                    "#9966FF", "#FF9F40", "#C9CBCF", "#8DFF57", "#FF5FA2", "#00C49F"
                                ]
                            }]
                        }
                    });
